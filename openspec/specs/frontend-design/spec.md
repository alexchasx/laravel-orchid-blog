...
Viewport-метатег страницы SHALL NOT содержать ограничения `maximum-scale` и `user-scalable=0`. Пользователь SHALL иметь возможность увеличивать страницу жестом или зумом браузера.
