...
### Requirement: Использование base.blade для публичных страниц

**Reason**: Заменён на `techlog.blade.php`
**Migration**: Все публичные страницы (`index`, `article`, `contact`) **SHALL** использовать `@extends('layouts.techlog')`
