<header class="pt-3 pb-3">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-4 justify-content-center mb-md-0 pl-3">
                <li>
                    <a class="button large round" href="https://github.com/chasovnikov">
                        GitHub
                    </a>
                </li>
                <li>
                    <a class="button large round" href="{{ route('contact') }}">Контакты</a>
                </li>


                @if (isAdmin())
                <li>
                    <a style="position: absolute;" href="{{ route('platform.main') }}" class="nav-link px-2 text-white border">
