...
var twemoji = (function () {
    ...
    var f = {
            ...
            onerror: function () {
                this.parentNode &&
                    this.parentNode.replaceChild(g(this.alt, !1), this);
            },
            parse: function (d, u) {
                ...
                return (
                    ...
                    attributes:
                        "function" == typeof u.attributes ? u.attributes : r,
    ...
    function i(d, u) {
        for (var f = [], c = 0, e = 0, b = 0; b < d.length; )
            (c = d.charCodeAt(b++)),
                e
                    ? (f.push(
                          (65536 + ((e - 55296) << 10) + (c - 56320)).toString(
                              16
                          )
                      ),
                      (e = 0))
